...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<DeleteCarInteractor>();
        services.AddScoped<AssignCarToTeacherInteractor>();
        services.AddScoped<UnassignCarFromTeacherInteractor>();
        services.AddScoped<GetTeacherInteractor>();
        services.AddScoped<FindTeachersInteractor>();
        services.AddScoped<GetCarInteractor>();
        services.AddScoped<FindCarsInteractor>();
